...
public class jaskierKarczmaFight2 {
    @FXML
    ...
    public jaskierKarczmaFight2() throws IOException {
    }

    @FXML
    protected void initialize() {
        banditHP.setText(String.valueOf(bandit2.maxHP));
        banditPower.setText(String.valueOf(bandit2.power));
        geraltPower.setText(String.valueOf(geralt.power));
        geraltHP.setText(String.valueOf(geralt.maxHP));
        banditRemainingHP.setText(String.valueOf(bandit2.maxHP));
    ...
    protected void onNormalAttack(ActionEvent actionEvent) throws IOException {
        ...
        if (geralt.currentHP - receivedDMG1 <= 0) {
            bandit2.currentHP = bandit2.maxHP;
            geralt.death(actionEvent);
        }
        if (bandit2.currentHP - dealtDMGn <= 0) {
            win(actionEvent);
        }

        if (geralt.currentHP > 0 && bandit2.currentHP > 0) {
            textDealtDamage.setText("Zadane obrażenia:");
            dealtDamage.setText(String.valueOf(dealtDMGn));
            bandit2.currentHP -= dealtDMGn;
    ...
    private void stats() {
        banditHP.setText(String.valueOf(bandit2.maxHP));
        banditPower.setText(String.valueOf(bandit2.power));
        banditRemainingHP.setText(String.valueOf(bandit2.currentHP));
        geraltPower.setText(String.valueOf(geralt.power));
        geraltHP.setText(String.valueOf(geralt.maxHP));
        geraltRemainingHP.setText(String.valueOf(geralt.currentHP));
    }
    ...
    private int receivedDMG1(ActionEvent actionEvent) throws IOException {
        int receivedDMG1 = (int) bandit2.onAttack(actionEvent);
        return receivedDMG1;
    }
    ...
    protected void onHardAttack(ActionEvent actionEvent) throws IOException {
        ...
        if (bandit2.currentHP - dealtDMGS <= 0) {
            win(actionEvent);
        }
    ...
    private void win(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(start.class.getResource("jaskierKarczma/win2.fxml"));
